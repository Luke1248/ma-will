...
enum CitationBank {
    ...
    static let additional: [Citation] = [
        ...
        Citation(category: .quotations, rule: "R5.1(b)", difficulty: 2, isCorrect: true,
            segments: [t("The Court called the statute “plain and unambiguous.”")],
            explanation: "A quotation of fewer than 50 words is run into the text in quotation marks; in American usage the closing period sits inside the closing quotation mark. Rule 5.1(b)."),
        Citation(category: .quotations, rule: "R5.1(a)", difficulty: 3, isCorrect: false,
            segments: [t("A 55-word quotation, "), bad("run into the text in quotation marks.", fix: "set off as an indented block quotation, without quotation marks.")],
            explanation: "A quotation of 50 or more words is set off as an indented block quotation, without quotation marks, and the citation follows the block rather than sitting inside it. Rule 5.1(a)."),
        Citation(category: .quotations, rule: "R5.2", difficulty: 3, isCorrect: false,
            segments: [t("The court held that “"), bad("The", fix: "[T]he"), t(" statute controls.”")],
            explanation: "When you change the case of a letter from the original, show the change with brackets: “[T]he.” Rule 5.2."),
        Citation(category: .quotations, rule: "R5.3", difficulty: 3, isCorrect: false,
            segments: [t("“the right "), bad("...", fix: ". . ."), t(" shall not be infringed.”")],
            explanation: "An omission within a quotation is shown by an ellipsis of three periods separated by spaces, with a space before and after. Rule 5.3."),
        Citation(category: .quotations, rule: "R5.3", difficulty: 4, isCorrect: false,
            segments: [t("“Congress shall make no law "), bad("…", fix: ". . ."), t(" abridging the freedom of speech.”")],
            explanation: "Use three periods separated by spaces ( . . . ), not a single ellipsis character, to mark an omission. Rule 5.3."),
        Citation(category: .quotations, rule: "R5.2", difficulty: 4, isCorrect: true,
            segments: [t("The statute “plainly controls” (emphasis added).")],
            explanation: "When you add emphasis to quoted language, note it in a parenthetical after the citation: (emphasis added). Rule 5.2."),
        Citation(category: .quotations, rule: "R5.1(b)", difficulty: 4, isCorrect: false,
            segments: [t("The Court called it “unambiguous"), bad("”.", fix: ".”")],
            explanation: "In American usage, commas and periods are placed inside the closing quotation mark. Rule 5.1(b)."),
        Citation(category: .quotations, rule: "R5.1(b)", difficulty: 5, isCorrect: true,
            segments: [t("The court invoked the ‘clear statement’ rule when reading “the Act.”")],
            explanation: "A quotation within a quotation takes single quotation marks inside the double marks. Rule 5.1(b)."),
    ]
}
